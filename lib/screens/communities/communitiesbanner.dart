...
class Communitiesbanner extends StatelessWidget {
  const Communitiesbanner({Key? key}) : super(key: key);
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          // Background Image
          Image.network(
            'https://cdn.builder.io/api/v1/image/assets/TEMP/5d8481a0802bdf7cc4ebfbcf9296c969eccbd050',
            fit: BoxFit.cover,
