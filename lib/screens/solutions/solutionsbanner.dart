...
class Solutionsbanner extends StatelessWidget {
  const Solutionsbanner({Key? key}) : super(key: key);
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          // Background Image
          Image.network(
            'https://cdn.builder.io/api/v1/image/assets/TEMP/43dd3bfa604775395f22152aa1208b4c3cd66849',
            fit: BoxFit.cover,
